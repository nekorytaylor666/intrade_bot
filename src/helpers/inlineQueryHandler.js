...
inlineHandler.on('inline_query', ctx => {
  ...
  if (query.startsWith('/')) {
    // If user input is @yourbot /command
    if (query.startsWith('/audio_src')) {
      // If user input is @yourbot /audio_src
    ...
    if (message_length > 0) {
      ...
      switch (dice) {
        ...
        case 3:
          full_message =
            name_target + ' is not a nice people for me...';
          break;
        case 4:
          full_message =
            name_target + ' for me you are c- Eh! You wanted!';
          break;
        case 5:
        ...
        case 7:
          full_message =
            'Sometimes I ask myself why people like ' +
            name_target +
            ' dress up and walk around like that...';
          break;
        case 8:
          full_message =
            'Watch him! Watch! ' + name_target + ' is so ugly!';
          break;
      }
        ...
        [
          {
            ...
            description:
              'What does bot thinks about ' + name_target + '?',
